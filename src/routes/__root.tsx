...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Servicio profesional de home staging y agente inmobiliario API entre Vilanova i la Geltrú, Sitges y Canyelles. Vende tu propiedad más rápido y al mejor precio." },
      { name: "author", content: "Clementine Homes" },
      { property: "og:title", content: "Clementine Homes — Vilanova, Sitges, Canyelles" },
      { property: "og:description", content: "Servicio profesional de home staging y agente inmobiliario API entre Vilanova i la Geltrú, Sitges y Canyelles. Vende tu propiedad más rápido y al mejor precio." },
